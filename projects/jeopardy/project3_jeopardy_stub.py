...
# return : list of strings containing exactly three unique categories of questions
...
# parameter:  fileList - list containing lines of a CSV file containing quiz data
#             categoryList - list containing exactly 3 categories from which to choose questions
