...
while playAgain == True:
    ...
    while validResponse == False:
        ...
        if genderResponse.lower() == "male":
            ...
            validResponse = True
        elif genderResponse.lower() == "female":
            preferredGenderOfSpouse = "female"
            validResponse = True
        else:
            print("I have never heard of the " + genderResponse + " gender, perhaps you can explain it to me later.")
